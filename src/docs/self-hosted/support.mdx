...
We strive to provide a great self-hosted experience for folks willing to try Sentry that way. The [onpremise repository](https://github.com/getsentry/onpremise) is geared towards low to medium loads with simplicity in mind. We believe keeping this setup simple is important to show
...
3. **DO** [file an issue](https://github.com/getsentry/onpremise/issues/new/choose) for missing docs, bugs during upgrades or installation
...
5. **DO** [submit PRs](https://github.com/getsentry/onpremise/compare) directly for simple fixes
